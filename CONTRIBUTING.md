# Contributing to QuHOLD

Thank you for considering contributing to the **QuHOLD** library! We welcome contributions from the community to help improve and enhance the library for everyone.
...
2. Clone Your Fork: Clone your forked repository to your local machine.
   ...
   ```sh
   git clone https://github.com/Qubix-Network/QuHOLD.git
   cd QuHOLD
   ```
...
By contributing to the **QuHOLD** library, you agree that your contributions will be licensed under the [MIT License](LICENSE).

Thank you for contributing and making **QuHOLD** even better!
